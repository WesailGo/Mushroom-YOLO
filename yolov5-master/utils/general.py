...
# def NMS(boxes, scores, iou_thres, GIoU=False, DIoU=True, CIoU=False): #使用DIoU
#     """
...
def plot_one_box(x, img, color=None, label=None, line_thickness=None):
    ...
    if label:
        ...
        cv2.putText(img, label, (c1[0], c1[1]-1), 0, tl / 3, [225, 255, 255], thickness=tf, lineType=cv2.LINE_AA)
